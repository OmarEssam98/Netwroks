...
class MyMessage_Base : public ::omnetpp::cPacket
{
  protected:
    int Seq_Num;
    int M_Type;    //Type of message sent => 0 for Data, 1 for +Ack, 2 for -Ack
    int Header[2];
    ::omnetpp::opp_string M_Payload;
    bits mycheckbits;   //CRC Byte
  ...
  public:
    ...
    virtual void setId(int id);   //Set ID for Header
    virtual void setTime(int time);   //Set Time for Header
    virtual int getId() const;   //Get Header ID
    virtual int getTime() const;   //Get Header Time
